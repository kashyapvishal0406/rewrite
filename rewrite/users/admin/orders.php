                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                      ...
                                      <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center text-white text-danger"> <i class="bx bx-radio-circle-marked bx-burst bx-rotate-90 align-middle font-18 me-1"></i>
                                                    <span>Pending</span>
                                                </div>
                                            </td>
                                            <td><a href="<?php echo $href_link; ?>?order_id=<?php echo $order_id; ?>" class="btn btn-light">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
