										...
										<tbody>
											...
											while ($row = mysqli_fetch_assoc($result)) {
												...
												<tr class="bg-<?php echo $randomColorName; ?> text-dark">
													...
													<td><button type="button" class="btn btn-dark docs_modal_button" data-bs-toggle="modal" data-bs-target="#exampleModal"
															data-service-id="<?php echo $service_id; ?>"><i class='bx bxs-file-doc'></i></button></td>

													<td><?php echo $row['price']; ?>/-</td>
													<td>
														<select class="form-select mb-3 text-dark" aria-label="Default select example">
													...
													<td><a href="buy_page_fields.php?service_name=<?php echo $service_name; ?>&service_id=<?php echo $service_id; ?>" class="btn btn-dark">Add to cart</a>
													</td>
												</tr>
											<?php } ?>
										</tbody>
