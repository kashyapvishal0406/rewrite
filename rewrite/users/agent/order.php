													...
													switch ($field_type) {
														case 'text':
															...
															<div class="col-md-6">
																...
																<input type="<?php echo $field_type; ?>" class="form-control order_input_field" placeholder="<?php echo $placeholder; ?>"
															...
															<span class="image-upload-wrapper">
																<div class="col-md-6">
																	...
																	<div class="input-group"> <span class="input-group-text"><i class="bx bxs-id-card"></i></span>
																		<input type="file" class="imageInput form-control border-start-0 order_input_field" accept="image/*" id="<?php echo $field_id; ?>">
																	</div>
																</div>
																<div class="col-6 mb-3">
																	<img class="imagePreview " style="width:40%;" src="" alt="Image Preview">
																</div>
															</span>
															<?php break;
														...
														case 'button':
															...
															?>
															<div class="col-md-6">
																<a href="<?php echo $href; ?>&service_id=<?php echo $service_id; ?>&order_id=<?php echo $order_id; ?>" class="btn btn-light btn-lg" id=""><?php echo $display_name; ?></a>
															</div>
