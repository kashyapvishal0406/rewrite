...
$fieldObjectJSON = $_GET['fieldObject'];

$fieldObject = json_decode($fieldObjectJSON, true);

$service_id = $fieldObject['service_id'];
$service_name = $fieldObject['service_name'];
// echo $service_id;

?>
<script>
	var fieldObject = JSON.parse('<?php echo $fieldObjectJSON; ?>');
							...
							<div class="card border-top border-0 border-4 border-white">
								<div class="card-body p-5">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-white">Documents Upload</h5>
									</div>
									<hr>
									...
									<form class="row">
										...
										while ($row = mysqli_fetch_assoc($result)) {
											...
											?>
											<div class="col-6 image-upload-wrapper mb-4">
												<div class="row">
													<div class="col-12">
														<label for="document_name" class="form-label h5 mb-2"><?php echo $document_name; ?></label>
														<input type="file" class="imageInput form-control service_docs_field" data-document-name="<?php echo $document_name; ?>">
													</div>
												</div>
												<div class="row">
													<div class="col-12">
									...
									<div class="col-12">
										<button class="btn btn-primary mt-3 float-end btn-lg buy_docs_next" data-service-id="<?php echo $service_id; ?>"
