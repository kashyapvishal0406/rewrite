														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<button type="button" class="btn btn-primary download_image_button" data-img-src="<?php echo $visiting_card; ?>"
													...
													<div class="modal fade" id="Banner" tabindex="-1" aria-labelledby="BannerLabel" aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
																	<button type="button" class="btn btn-primary download_image_button" data-img-src="<?php echo $banner; ?>"
													...
													<div class="modal fade" id="Poster" tabindex="-1" aria-labelledby="PosterLabel" aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
																	<button type="button" class="btn btn-primary download_image_button" data-img-src="<?php echo $poster; ?>"
										...
										<div class="col">
											<div class="card">
												...
												<div class="card-body">
													...
													<button type="button" class="btn btn-light mt-2" data-bs-toggle="modal" data-bs-target="#id_card">Open</button>


													<div class="modal fade" id="id_card" tabindex="-1" aria-labelledby="BannerLabel" aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																<div class="modal-header">
																...
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
																	<button type="button" class="btn btn-primary download_image_button" data-img-src="<?php echo $id_card; ?>"
												...
												<div class="col">
													<div class="card">
														...
														<ul class="list-group list-group-flush">
															<li class="list-group-item">Name : <?php echo $agent_details['relationship_manager']; ?></li>
												...
												<div class="col">
													<div class="card">
														...
														<ul class="list-group list-group-flush">
															...
															<li class="list-group-item">E-mail : director@techtionsolution.com</li>
														</ul>
													</div>
												</div>
											</div>
