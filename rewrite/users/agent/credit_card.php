								...
								while ($vendor_row = mysqli_fetch_assoc($vendor_result)) {
									...
									<div class="col-lg-3">
										<div class="card radius-10 bg-<?php echo $randomColorName; ?>">
											...
											<div class="card-body">
												<img src="assets/images/<?php echo $vendor_image;?>" class="card-img-top" alt="...">
												<div class="d-flex align-items-center">
													<h4 class="my-1 pb-3 text-dark"><?php echo $vendor_name; ?></h4>
												</div>
												<a href="order_form.php?service_name=BOB Personal Loan&amp;service_id=<?php echo $service_id; ?>&page=mobile_verification"
													class="btn btn-light text-dark px-2 ">Upload
													Documents</a>
												<a href="<?php echo $vendor_link; ?>" class="btn btn-light px-2 float-end text-dark" target="_blank">Visit Link</a>
											</div>
										</div>
									</div>
								<?php } ?>
