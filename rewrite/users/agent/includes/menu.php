                    ...
                    while ($menu_categories_row = mysqli_fetch_assoc($menu_categories_result)) {
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
                                ...
                                <div class="menu-title d-flex align-items-center"><?php echo $category_name; ?></div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                while ($menu_service_row = mysqli_fetch_assoc($menu_service_result)) {
                                    ...
                                    ?>
                                    <li><a class="dropdown-item" href="service_order_router.php?service_id=<?php echo $menu_service_id; ?>&service_name=<?php echo $menu_service_name; ?>&category_id=<?php echo $category_id; ?>"><i class='bx bx-table'></i><?php echo $menu_service_name; ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
