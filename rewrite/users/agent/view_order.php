											...
											<div class="row">
												<div class="col-md-12 mb-3">
													<div class="row px-2">
														...
														<div class="col-md-12 mb-3">
															<label for="fullname" class="form-label">Customer's Address</label>
									...
									<div class="card border-top border-0 border-4 border-white">
										<div class="card-body p-5">
											<div class="row">
												<div class="col-md-12 mb-3">
													<div class="row px-2">
														<h5 class="mt-3 text-white">Uploaded Documents</h5>
														<hr>
														<?php
														$sql_order_details = "SELECT * FROM `order_details` WHERE `type` = 2 AND order_id = $order_id";
														$result_order_details = mysqli_query($conn, $sql_order_details);
														while ($row_order_details = mysqli_fetch_assoc($result_order_details)) {
															$document_name = $row_order_details['name'];
															$document_value = $row_order_details['value'];
															$image_name = $document_value;
															?>

															<div class="col-md-4 mt-2 mb-3">
																<div class="card">
																	<img src="../../data/order_images/<?php echo $image_name; ?>" class="card-img-top" alt="...">
																	<div class="card-body">
																		<h5 class="card-title"><?php echo $document_name; ?></h5>
																		<a href="../../data/order_images/<?php echo $image_name; ?>" class="btn btn-warning float-end" download>Download</a>
																	</div>
																</div>
															</div>
														<?php } ?>
