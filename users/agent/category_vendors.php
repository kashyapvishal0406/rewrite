...
$recieved_category_name = $_GET['category_name'];
?>
				...
				<div class="page-content">
						...
						<div class="ps-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Labour and Pension</li>
								</ol>
							</nav>
						</div>
					...
					<div class="row">
						...
						<div class="col-10">
							<div class="row">
								<?php
								$vendor_sql = "SELECT * FROM category_vendors WHERE category_id=$recieved_category_id";
								...
								while ($vendor_row = mysqli_fetch_assoc($vendor_result)) {
									...
									<div class="col-lg-3">
										<div class="card radius-10 bg-<?php echo $randomColorName; ?>">
											<div class="card-body">
												<a href="<?php echo $vendor_link; ?>" target="_blank">
													<div class="d-flex align-items-center">
														<h4 class="my-1 pb-3 text-dark"><?php echo $vendor_name; ?>
														</h4>
														</div>
													</a>
												</div>
												<?php
													if ($vendor_name == 'New Ticket Booking') {
														?>
														<p class="text-white ms-3">User name: suraj0789xdb</p>
														<p class="text-white ms-3">Password: null</p>
													<?php } ?>
											</div>
										</div>
								<?php } ?>
