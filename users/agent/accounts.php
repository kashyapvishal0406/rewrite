									...
									<div class="card radius-10 bg-<?php echo $randomColorName; ?>">
										<div class="card-body">
											<div class="d-flex align-items-center">
												<h4 class="my-1 py-3 text-dark"><a
														href="link_order_form.php?service_id=<?php echo $service_id; ?>&service_name=<?php echo $vendor_name; ?>&vendor_link=<?php echo $vendor_link; ?>"
														class="text-dark">
