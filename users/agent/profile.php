...
<body class="bg-theme bg-theme2">
							...
							<div class="col">
								...
								<div class="card border-top border-0 border-4 border-white">
									<div class="card-body p-5">
										...
										<form class="row g-3">
											...
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="date" class="form-control border-start-0" id="dob"
														value="<?php echo $agent_details['dob'] ?>">
												</div>
											</div>
												...
												<div class="col-md-6">
													...
													<div class="input-group"> <span class="input-group-text"><i
														...
														<input type="file"
															...
															id="profile_img" accept="image/png, image/jpeg, image/jpg">
												...
												<div class="col-12 mb-3">
													<?php if (!empty($agent_details['profile_img'])): ?>
														<img class="imagePreview"
															src="<?php echo "../../data/user_images/" . $agent_details['profile_img']; ?>"
											...
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0"
														...
														value="<?php echo $agent_details['mobile']; ?>">
												</div>
											</div>
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0" id="whatsapp"
														...
														value="<?php echo $agent_details['whatsapp']; ?>">
												</div>
											</div>
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0" id="email"
														...
														value="<?php echo $agent_details['email']; ?>">
												</div>
											</div>
											...
											<div class="col-12">
												...
												<textarea class="form-control" id="address" placeholder="Enter Address"
													rows="3"><?php echo $agent_details['address']; ?></textarea>
											</div>
											...
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0" id="city"
														placeholder="City"
														value="<?php echo $agent_details['city']; ?>">
												</div>
											</div>
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0" id="pincode"
														placeholder="Pincode"
														value="<?php echo $agent_details['pincode']; ?>">
												</div>
											</div>
											...
											<div class="row">
												<div class="col">
													<div class="row">
														...
														<span class="image-upload-wrapper">
															<div class="col-12 mb-3">
																<label for="aadhaar_number" class="form-label">Upload
																	Aadhaar Front</label>
															...
															<div class="col-12 mb-3">
																<?php if (!empty($agent_details['aadhaar_front_img'])): ?>
																	<img class="imagePreview"
																		src="<?php echo "../../data/user_images/" . $agent_details['aadhaar_front_img']; ?>"
																		alt="Image Preview" style="display:block;">
																<?php else: ?>
																	<img class="imagePreview" src="" alt="Image Preview"
																		style="display: none;">
														...
														<span class="image-upload-wrapper">
															...
															<div class="col-12 mb-3">
																<?php if (!empty($agent_details['aadhaar_back_img'])): ?>
																	<img class="imagePreview"
																		src="<?php echo "../../data/user_images/" . $agent_details['aadhaar_back_img']; ?>"
																		alt="Image Preview" style="display:block;">
																<?php else: ?>
																	<img class="imagePreview" src="" alt="Image Preview"
																		style="display: none;">
														...
														<span class="image-upload-wrapper">
															...
															<div class="col-12">
																<?php if (!empty($agent_details['pan_img'])): ?>
																	<img class="imagePreview"
																		src="<?php echo "../../data/user_images/" . $agent_details['pan_img']; ?>"
																		alt="Image Preview" style="display:block;">
																<?php else: ?>
																	<img class="imagePreview" src="" alt="Image Preview"
																		style="display: none;">
											...
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
															class='bx bx-list-check'></i></span>
													<input type="text" class="form-control border-start-0"
														id="benificiary_name" placeholder="Benificiary Name"
														value="<?php echo $agent_details['benificiary_name']; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<label for="benificiary_account_number" class="form-label">Benificiary
											...
											<div class="col-md-6">
												...
												<div class="input-group"> <span class="input-group-text"><i
													...
													<input type="text" class="form-control border-start-0" id="ifsc"
														...
														value="<?php echo $agent_details['ifsc']; ?>">
												</div>
											</div>
										...
										<div class="col-12">
											<button id="update_profile"
												class="btn btn-light px-5 float-end mt-3">Save</button>
										</div>
									</div>
								</div>
	...
	<script src="assets/js/script.js?version=3"></script>
	<script>
		$(function () {
