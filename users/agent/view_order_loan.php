													...
													<div class="col-md-12 mb-3">
														<div class="row px-2">
															...
															<div class="col-md-6 mb-3">
																<label for="fullname" class="form-label">Order
																	ID</label>
															...
															<div class="col-md-8 mb-3">
																<label for="fullname" class="form-label">Service
																	Name</label>
																<input type="text" class="form-control"
													...
													<div class="row px-2">
														...
														<div class="col-md-6 mb-3">
															<label for="fullname" class="form-label">
																Email </label>
															<input type="text" class="form-control"
																value="<?php echo $order_details_data['email']; ?>"
																id="email" disabled="">
														</div>
												...
												<div class="col-md-12 mb-3">
													<div class="row px-2">
														...
														<div class="col-md-6 mb-3">
															...
															<input type="text" class="form-control"
																value="<?php echo $order_details_data['ifsc']; ?>"
