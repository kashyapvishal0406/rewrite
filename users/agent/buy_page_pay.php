									...
									<div class="card border-top border-0 border-4 border-white">
										<div class="card-body p-5">
											<div class="card-title d-flex align-items-center">
												...
												<h5 class="mb-0 text-white">Make Payment</h5>
											</div>
											<hr>
											...
											<div class="row">
												...
												<div class="col-5">
													...
													<div class="card mt-3 mb-5 mb-lg-0">
														<div class="card-header py-3 bg-warning">
															<h5 class="card-title text-white text-uppercase text-center">How to Make Payment</h5>
														</div>
														<div class="card-body">
															<p>You can make payment Via UPI or Direct Bank transfer.</p>
															<p>Once you are done with UPI or Bank Transfer, Please upload the screenshot below</p>
															<p>We'll notify you once we verify the payment from our backend.</p>
														</div>
													</div>
												</div>
												...
												<div class="col-4 image-upload-wrapper mb-4">
													<div class="row">
														<div class="col-12">
															<label for="document_name" class="form-label h4 mb-3">Upload Screenshot Of Payment</label>
											...
											<div class="col-12">
												<button class="btn btn-primary mt-3 float-end btn-lg buy_pay_submit" data-order-id="<?php echo $order_id; ?>">Submit</button>
											</div>
